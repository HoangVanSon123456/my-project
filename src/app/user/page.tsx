    ...
    <>
      <div className="flex flex-row mx-5 mt-5 justify-between">
        ...
        <div className="items-end">
          ...
          <button
            type="button"
            className="text-gray-700 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 "
          >
            Xuất tài liệu
          </button>
        </div>
      ...
      <div className="mx-5 mt-4">
        <section className="bg-white rounded-lg">
          <div className=" mx-5 lg:py-4">
            <h2 className="mb-3 text-xl font-bold text-gray-900 ">Tìm kiếm</h2>
            <form action="#">
      ...
      <ModalUserUpdate showModal={showModal} />
    </>
  );
}
